...
Matrix Example:
    Consider the case of reading temprature for 1 week measured in the morning, mid-day, evening and mid-night. We can determine the shape of the matrix by using the `.shape` attribute on the data object. In this case since we have 5 columns of data and 7 days of the week, the shape is 7x5.
