...
# +--------------------------------------------------------------------------------------------+
################################################################################################
# ALGORITHMS_CORE_DIR="${ALGORITHMS_DIR}/core"
# if [[ -d ${ALGORITHMS_CORE_DIR} ]]; then
#   # Change directory to Cython dir.
#   cd ${ALGORITHMS_CORE_DIR} || exit

#   echo -e "${bpurple}Removing Cython shared objects & DLLs...${reset}"

#   # Clean shared objects and cpp files.
#   clean_ext ${ALGORITHMS_CORE_DIR} "so"  # Remove all shared objects. *.so files.
#   clean_ext ${ALGORITHMS_CORE_DIR} "cpp" # Remove all generated cpp files.
...
# else
#   echo
#   echo -e "${red}No such file or directory: ${ured}\"${ALGORITHMS_CORE_DIR}\"${reset}"
# fi
